...
//adon 
SlideDeck.prototype.renderIFrame_ = function(pre, iframe) {
  var doc = iframe.contentWindow.document;
  doc.body.innerHTML = pre.textContent;
  // execute the scripts, if any
  [].forEach.call(doc.body.getElementsByTagName('script'), function(script) {
...
SlideDeck.prototype.renderHTMLDemo_ = function(settings) {
  var iframe, self = this;

  [].forEach.call(document.querySelectorAll('section.demoHTML'), function(el){
    ...
    pre.addEventListener('blur', function(e){
      self.renderIFrame_(this, this.parentNode.querySelector('iframe'));
